...
const Feature = ({
  ...
  return (
    ...
    >
      ...
      {index >= 4 && (
        <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-b from-neutral-800/80 to-transparent pointer-events-none" />
      )}
